...
class Command(BaseCommand):
    """
    Cleans Registered Drugs - remove itemid if no longer in Item database, assign Item
    """
    help = 'Cleans Registered Drugs - remove itemid if no longer in Item database, assign Item'
