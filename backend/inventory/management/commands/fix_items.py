...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        #             item = None
        #             print(f"Item #{record.itemid} does not exist. Removing itemid from {record}")
        #             record.itemid = None     
        #             record.save()
        #             removed += 1
        ...
        #         cmsitem = None
        #     if cmsitem:
        #         # Found matching CMS InventoryItem
        #         item_data = {
        #             'name': record.name,
        #             'cmsid': cmsitem.id,
        ...
        #         if created:
        #             print(f"Created item #{item.id} for {record}")
        #         else:
        #             print(f"Updated item #{item.id} for {record}")
        ...
        #         if record.itemid:
        #             print(f"Unexpected record.itemid={record.itemid}. Set as None")
        #             record.itemid = None
        #             record.save()
        #             fixed += 1
        #         else:
        #             sys.stdout.write(".")
        # print(f"Processed {count} registered drugs; fixed: {fixed}; removed items: {removed}")
