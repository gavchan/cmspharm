...
urlpatterns = [
    ...
    path('delivery/<int:delivery_id>/item/<int:pk>/delete/modal/', views.DeliveryItemDeleteModal.as_view(), name='DeliveryItemDeleteModal'),
    path('delivery/<int:delivery_id>/item/<int:pk>/update/modal/', views.DeliveryItemUpdateModal.as_view(), name='DeliveryItemUpdateModal'),
    path('delivery/<int:delivery_id>/item/<int:pk>/modal/', views.DeliveryItemDetailModal.as_view(), name='DeliveryItemDetailModal'),
    ...
    path('delivery/<int:delivery_id>/togglesynced/', views.DeliveryOrderToggleSynced, name='DeliveryOrderToggleSynced'),
    ...
    path('item/new/modal/', views.NewItemModal.as_view(), name='NewItemModal'),
